...
The [`@woven-ecs/editor-store`](/editor-store/introduction/) package extends Woven-ECS with everything you need to build multiplayer editor applications like infinite canvases and creative design tools.
