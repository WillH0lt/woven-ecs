...
const Velocity = defineEditorComponent(
...
const Linked = defineEditorComponent(
...
const Unsyncable = defineEditorComponent(
...
const UnsyncedSingleton = defineEditorSingleton(
