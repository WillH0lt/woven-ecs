# @woven-ecs/editor-store-server

Real-time collaboration server for [@woven-ecs/editor-store](https://www.npmjs.com/package/@woven-ecs/editor-store) clients.
...
```typescript
import { MemoryStorage } from '@woven-ecs/editor-store-server';
...
```typescript
import { FileStorage } from '@woven-ecs/editor-store-server';
...
```typescript
import type { Storage, RoomSnapshot } from '@woven-ecs/editor-store-server';
...
Connect from the browser using [@woven-ecs/editor-store](https://www.npmjs.com/package/@woven-ecs/editor-store):

```typescript
import { EditorStore } from '@woven-ecs/editor-store';
